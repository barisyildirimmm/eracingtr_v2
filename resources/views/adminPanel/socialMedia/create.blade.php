    ...
    <div class="container">
        <div class="page-header-card">
            <h1 class="mb-0">
                ...
                Yeni Sosyal Medya Paylaşımı
            </h1>
            <p class="mb-0 mt-2 opacity-90">Tüm sosyal medya platformlarında paylaşım oluşturun</p>
        </div>
        ...
        <form action="{{ route('admin.socialMedia.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-card">
                ...
                <div class="image-upload-area" onclick="document.getElementById('images').click()">
                    ...
                    <p class="mb-0">Fotoğraf eklemek için tıklayın veya sürükleyip bırakın</p>
            ...
            <div class="form-card">
                ...
                <div class="platform-checkbox platform-instagram-reels">
                    <input type="checkbox" id="platform_instagram_reels" name="platforms[]" value="instagram_reels">
                ...
                <div class="platform-checkbox platform-instagram-story">
                    <input type="checkbox" id="platform_instagram_story" name="platforms[]" value="instagram_story">
                ...
                <div class="platform-checkbox platform-youtube">
                    <input type="checkbox" id="platform_youtube" name="platforms[]" value="youtube_shorts">
